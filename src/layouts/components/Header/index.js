        ...
        <div className={cx('actions')}>
          {currentUser ? (
            <>
              ...
              <Tippy content="Messages" placement="bottom" delay={[0, 150]}>
                <button className={cx('action-btn')}>
                  <MessageIcon />
                </button>
              </Tippy>
              <Tippy content="Mailbox" placement="bottom" delay={[0, 150]}>
                <button className={cx('action-btn')}>
                  <InboxIcon />
                </button>
              </Tippy>
            ...
            <>
              ...
              {/* <Button plus rounded >Download</Button> */}
              {/* <Button outline className={cx('customize')}>Customize</Button> */}
            </>
          )}
          <Menu items={currentUser ? userMenu : MENU_ITEMS} onChange={handleMenuChange}>
            {currentUser ? (
              <Image
                ...
                src={
                  'https://p16-sign-sg.tiktokcdn.com/aweme/100x100/tos-alisg-avt-0068/9198e5096a2279ae13ddd09074e305a8.jpeg?x-expires=1653638400&x-signature=T5fvPk5ln90XFU41Ma1GO9FU%2Ft8%3D'
                }
                alt="ThaiDaiNhan"
              />
            ) : (
